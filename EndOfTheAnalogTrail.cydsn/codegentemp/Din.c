...
#define SetP4PinDriveMode(shift, mode)  \
    do { \
        Din_PC =   (Din_PC & \
                                (uint32)(~(uint32)(Din_DRIVE_MODE_IND_MASK << (Din_DRIVE_MODE_BITS * (shift))))) | \
                                (uint32)((uint32)(mode) << (Din_DRIVE_MODE_BITS * (shift))); \
    } while (0)
...
*
*  Din_DM_STRONG     Strong Drive 
*  Din_DM_OD_HI      Open Drain, Drives High 
*  Din_DM_OD_LO      Open Drain, Drives Low 
*  Din_DM_RES_UP     Resistive Pull Up 
*  Din_DM_RES_DWN    Resistive Pull Down 
*  Din_DM_RES_UPDWN  Resistive Pull Up/Down 
*  Din_DM_DIG_HIZ    High Impedance Digital 
*  Din_DM_ALG_HIZ    High Impedance Analog 
*
* Return: 
*  None
*
...
{
	SetP4PinDriveMode(Din__0__SHIFT, mode);
}
